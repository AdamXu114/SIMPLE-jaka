"""Keyboard controller for the Jaka MF policy.

Ported from sim2real-jaka ``rl_policy/controllers/keyboard.py``. Keys:
  i → init, o → zero, [ → align, ] → policy.
"""
...
from simple.jaka_rl.control_mode import resolve_keyboard_control_mode
