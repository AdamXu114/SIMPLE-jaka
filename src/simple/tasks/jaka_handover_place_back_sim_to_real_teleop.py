...
Standalone Jaka teleop task: hand over the object and place it back (sim-to-real).
"""
...
@TaskRegistry.register("jaka_handover_place_back_sim_to_real_teleop")
class JakaHandoverPlaceBackSimToRealTeleop(Task):
    uid: str = "jaka_handover_place_back_sim_to_real_teleop"
    label: str = "Jaka HandoverPlaceBack SimToReal Teleop"
    description: str = (
        "A task where the Jaka robot must hand over the object and place it back "
    ...
    dr_cfgs = dict(
        language=LanguageDRCfg(instructions=["hand over the object and place it back"]),
