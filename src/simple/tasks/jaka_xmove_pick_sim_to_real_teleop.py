...
Standalone Jaka teleop task: move forward and pick up the object (sim-to-real).
"""
...
@TaskRegistry.register("jaka_xmove_pick_sim_to_real_teleop")
class JakaXMovePickSimToRealTeleop(Task):
    uid: str = "jaka_xmove_pick_sim_to_real_teleop"
    label: str = "Jaka XMovePick SimToReal Teleop"
    description: str = (
    ...
    dr_cfgs = dict(
        ...
        spatial=SpatialDRCfg(
            spatial_mode="random",
            robot_region=Box(low=[-1.60, 0.0, 0.0], high=[-1.50, 0.0, 0.0]),
