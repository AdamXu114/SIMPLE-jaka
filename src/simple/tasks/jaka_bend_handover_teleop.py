...
@TaskRegistry.register("jaka_bend_handover_teleop")
class JakaBendHandoverTeleop(Task):
    uid: str = "jaka_bend_handover_teleop"
    label: str = "Jaka BendHandover Teleop"
    description: str = (
        "A task where the Jaka robot must bend down, pick up and hand over "
        "the object."
    )
    ...
    dr_cfgs: dict[str, Any] = dict(
        language=LanguageDRCfg(instructions=["bend down, pick up and handover the object"]),
