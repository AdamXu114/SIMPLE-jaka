...
@TaskRegistry.register("jaka_xmove_bend_pick_teleop")
class JakaXMoveBendPickTeleop(Task):
    uid: str = "jaka_xmove_bend_pick_teleop"
    label: str = "Jaka XMove BendPick Teleop"
    description: str = (
        "A task where the Jaka robot must move forward, bend down and pick up "
        "the object."
    )
    ...
    dr_cfgs: dict[str, Any] = dict(
        language=LanguageDRCfg(instructions=["move forward, bend down and pick up the object"]),
